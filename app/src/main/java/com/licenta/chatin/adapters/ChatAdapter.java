...
import com.licenta.chatin.databinding.ItemContainerReceivedMessageBinding;
import com.licenta.chatin.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class SentMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            if (chatMessage.message.startsWith(Constants.MESSAGE_IMAGE_PREFIX)) {
                binding.textMessage.setVisibility(View.GONE);
                binding.textImage.setVisibility(View.VISIBLE);
                String encodedImageData = chatMessage.message.substring(4);
                Bitmap bitmap = getBitmapFromEncodedString(encodedImageData);
